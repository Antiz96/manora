...
Run `manora` to open a TUI menu (made with [Ratatui](https://ratatui.rs/)) that allows searching through local man pages, downloading man pages from <https://manned.org>, and displaying them as PDF files.
